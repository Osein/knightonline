...
public:
	...
	static INT_PTR CALLBACK DlgProcProgress(HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam);
	static INT_PTR CALLBACK DlgProcPane(HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam);
	CN3E2Wrapper();
