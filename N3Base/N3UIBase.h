...
public:	
	...
	void ChangeImagePath(const std::string& szPathOld, const std::string& szPathNew);

	void ChangeFont(const std::string& szFont);
	...
	bool ReplaceAllTextures(const std::string& strFind, const std::string& strReplace);
#endif
};
